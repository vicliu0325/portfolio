    ...
    <div id='projects' className='max-w-[1040px] m-auto md:pl-28 p-4 py-16'>
        ...
        <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-gray-200 to-[#001b5e]'>
            ...
            <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
                <h3 className='text-xl font-bold text-white tracking-wider text-center pb-2 pt-2'>
                缺E-BOOK
                <br />電子書販售平台
                </h3>
                <p className='pb-4 text-white text-center text-sm'>React / Next.js + Chat engine.io</p>
        ...
        <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-gray-200 to-[#001b5e]'>
            ...
            <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
                ...
                <p className='pb-4 text-white text-center text-sm'>Leaflet + OpenStreetMap api</p>
                <p className='text-center p-2 rounded-lg bg-white to-gray-700 font-bold cursor-pointer text-lg hover:scale-110 ease-in duration-300'>More Info
                </p>
                </a>
            </div>       
        ...
        <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-gray-200 to-[#001b5e]'>
            ...
            <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
                ...
                {/* <p className='pb-4 pt-2 text-white text-center'>React</p> */}
                <p className='pb-4 text-white text-center text-sm'>Google Map api</p>
